...
public class Gameplay extends javax.swing.JPanel {
   ...
   private void gameSet() {
    if (!btn_01.isEnabled() && !btn_02.isEnabled() && !btn_03.isEnabled() && !btn_04.isEnabled() &&
        !btn_05.isEnabled() && !btn_06.isEnabled() && !btn_07.isEnabled() && !btn_08.isEnabled() &&
        !btn_09.isEnabled() && !btn_10.isEnabled() && !btn_11.isEnabled() && !btn_12.isEnabled() &&
        !btn_13.isEnabled() && !btn_14.isEnabled() && !btn_15.isEnabled() && !btn_16.isEnabled()) 
    {
        gameplay.setNewContent(new GameOverScreen(gameplay, intentos, puntaje));
    }
}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MEMORAMA SPIDER-VERSE");
